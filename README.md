...
2. **Join & Ready** — teams choose an alliance (Red/Blue) from their station page and mark themselves ready. Joining hands the Driver Station to the field (disabled until the match starts — leave the match to drive freely). If the Driver Station isn't talking to the FMS yet, the station page shows a warning, but teams can still ready up.
