...
**Standing up a new field? Start with
[getting-started.md](getting-started.md)** — a linear checklist from bare
hardware to your first match.

Otherwise, the [project README](../README.md) has the overview and quick
